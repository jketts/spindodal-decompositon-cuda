...
// note from josh  - adjusted length from 128 to 16. length must be a power of 2. 
...
double *device_phisum2d_A;
double *device_phisum2d_B;
double *device_phisum1d_A;
double *device_phisum1d_B;
...
//{
//   return unsigned int(x > 0.0 ? x + 0.5 : x - 0.5);
//   
//}
